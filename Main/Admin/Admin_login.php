        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="/PlacementAuto/Main/examples/dashboard.html" method="get">
                ...
                <div class="text-center">
                  <button type="button" class="btn btn-primary my-4" onclick=           "window.location.href = '/PlacementAuto/Main/Admin/Admin_dashboard.html';">Sign in</button>
                </div>
              </form>
            </div>
          </div>
