...
">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="/PlacementAuto/Main/Admin/Admin_tables.php">
              <i class="ni ni-bullet-list-67 text-red"></i> Tables
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/PlacementAuto/Main/Admin/Admin_register.php">
              <i class="ni ni-circle-08 text-pink"></i> Company Entry
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/PlacementAuto/Landing/landing.php">
