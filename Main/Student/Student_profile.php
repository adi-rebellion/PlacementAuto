...
">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <li class="nav-item ">
            <a class="nav-link " href="/PlacementAuto/Main/Student/Student_dashboard.php">
          ...
          <li class="nav-item">
            <a class="nav-link " href="/PlacementAuto/Main/Student/Student_tables.php">
              <i class="ni ni-bullet-list-67 text-red"></i> Companies
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/PlacementAuto/Main/Student/Student_login.php">
              <i class="ni ni-key-25 text-info"></i> Login
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/PlacementAuto/Main/Student/Student_register.php">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="<?=$_SESSION['user']['picture']; ?>" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
              ...
              <form action="insert.php" method="POST">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username" name="username" required>Username</label>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name" name="fname">First name</label>
                        <input type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="First name" value="Lucky">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name" name="lname">Last name</label>
                ...
                <div class="pl-lg-4">
                  ...
                  <button type="button" class="btn btn-primary my-4" onclick= "window.location.href = '/PlacementAuto/Main/Student/Student_profile.php';">Sign in</button>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2020 <a href="https://www.linkedin.com/in/aditya-naidu-566802160 class="font-weight-bold ml-1" target="_blank">AdityaNaidu</a>
            </div>
          </div>
         </div>
      </footer>
